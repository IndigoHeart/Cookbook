...
namespace Cookbook.Controllers
{
    public class MealTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeOfMeal")] MealType mealType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeOfMeal")] MealType mealType)
        {
            if (id != mealType.Id)
            {
                return NotFound();
